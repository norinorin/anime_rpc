...
<p align="center">
  A Discord Rich Presence integration that shows what anime (or really, anything) you are watching.
</p>
...
| url?            | `""`                                                    | Set to a MAL URL to enable scraping for metadata and episode titles.                                                                    |
| rewatching?     | `0`                                                     | Set to `1` if you're rewatching the anime.                                                                                                                           |
| application_id? | `1088900742523392133` (anime)                           | Discord application ID. To display "Watching a stream" instead for non-anime use, use `stream`. Otherwise, you can create your own app and use its `application_id`. |
